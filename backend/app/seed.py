...
def seed_improvement_measures():
    ...
    rows = [
        ...
        dict(name="Double glazing with metal or plastic frames", applies_to="window", lifetime_years=28, cost_per_m2=None,
             cost_guidance="~£1000 per window (not per m2) - set cost manually when applying.",
